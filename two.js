...
var name = "My name is Sanjoy";
name = "My name is Roni";
// console.log(name);
name = "Im fourteen years old"
console.log(name);


//using let variable and variable value change
let country = "Im form Bangladesh";
country = "Now im in London";
console.log(country);


let place = "Now im in Madaripur";
place = "Im going to Dhaka";
place = "Now im in Faridpur"
place = 230;
console.log(place);



// cont value variablae chnage 
const covidTest = "Positive";
